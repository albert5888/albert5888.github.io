...
### why-so-serials
 ...
 - 上傳.shtml
    ...
    ![](https://i.imgur.com/6MBqfic.png)

 - 取得validationKey

   ![](https://i.imgur.com/dslQNTw.png)
 ...
 - 使用python將serialized_data加上validation_key 
    ...
    ![](https://i.imgur.com/ChkZszk.png)

- 送出viewstate

    ![](https://i.imgur.com/NvVFesp.png)

- 取得reverse shell

    ![](https://i.imgur.com/7G8DaPk.png)

    ![](https://i.imgur.com/8CxJuEw.png)


### papapa

- 憑證domain (很可疑~)
    ![](https://i.imgur.com/ffeOVhU.png)

- 內文
    ![](https://i.imgur.com/4BG0qv6.png)

- 修改Host (讓它連線到flag站台)
    ![](https://i.imgur.com/FRunn6N.png)
...
### yeeclass
 ...
 - 查看公開的submissions
    ...
    ![](https://i.imgur.com/FxEUkbA.png)

 - 發現homeworkid=1沒有權限查看
 
    ![](https://i.imgur.com/IerSHSy.png)
    
 - 使用未登入帳號繞過
    ![](https://i.imgur.com/gr87wSM.png)
 
 - 自己發個測試，貼文規則為
     ```
     http://rectf.hitcon2023.online:30203/submission.php?hash=sha1(username_{timestamp}{microseconds})
     ```
      ![](https://i.imgur.com/bzzpkt3.png)
...
- 使用xxd
    ...
    ```
    ![](https://i.imgur.com/zde8mKK.png)

- 縮小

    ![](https://i.imgur.com/6uz0rPN.png)
...
- 執行php
    ...
    ![](https://i.imgur.com/x2xN5UT.png)

## The End
![](https://i.imgur.com/RvQMBEr.png)
