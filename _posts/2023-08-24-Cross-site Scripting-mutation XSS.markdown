...
## HTML parser (Chrome)
 ...
 - html parse (開頭div)
    ...
    ![](https://i.imgur.com/ZyxTtrM.png){:h="80%" w="80%"}

 - </div>設為script title, script和div也自動閉合

    ![](https://i.imgur.com/UGVORnM.png){:h="80%" w="80%"}

## JS parser (Chrome)

 - js parse (開頭script)

    ![](https://i.imgur.com/92W4gdQ.png){:h="80%" w="80%"}

 - script在head, <div title=" 被放在script

    ![](https://i.imgur.com/kiguYfr.png){:h="80%" w="80%"}
