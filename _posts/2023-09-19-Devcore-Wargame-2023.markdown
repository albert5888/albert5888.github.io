...
![](https://i.imgur.com/vK1GVc5.png){:h="80%" w="80%"}
...
![](https://i.imgur.com/h6yPiM4.png)

### flag2

 - 將sig轉成array，跳過驗證讀取其他編號
 ![](https://i.imgur.com/6uO1jRo.png)

 ### flag3 

 - print.php 存在sqli
![](https://i.imgur.com/62LkzFg.png)

 - 確認sqli
![](https://i.imgur.com/L4lIrrU.png)

- 撈出FLAG
![](https://i.imgur.com/HV2C3S2.png)
...
### flag5
 ...
 ![](https://i.imgur.com/2AXtVBy.png) 
 
 - 加上rename和folder，就可以上傳到其他地方

![](https://i.imgur.com/CerZ7f2.png)

- 這時會先有一個flag
![](https://i.imgur.com/ILZkjSa.png)
